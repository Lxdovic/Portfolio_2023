const ProjectCard = (props: any) => {
  ...
  return (
    <a href={href} className="panel lg:w-[50rem] h-1/2 px-4 md:px-10">
      <div className="overflow-hidden relative border bg-darker hover:bg-darkest transition lg:w-auto w-screen flex flex-col gap-4 border-white/25 rounded-xl p-10 h-full">
